...
// Tu código acá:
const name = document.querySelector('#createdBy').innerHTML = 'Aplicacion creada por Facundo Sanchez'
...
function buildToDo(todo, index) {
  ...
  buttonDelete.innerHTML = 'Pasar a complete'
  buttonDelete.addEventListener('click', completeToDo)
  ...
  toDoShell.appendChild(buttonDelete)
  return toDoShell
}
